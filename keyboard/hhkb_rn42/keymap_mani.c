/* 
 * Mani: my personal keymap, based on hasu's
 */
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KEYMAP(ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSLS,GRV, \
           ...
           LSFT, Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, FN2, RSFT,FN1, \
                LGUI,LALT,          FN4,                RALT, RGUI),

    /* Layer 1: HHKB mode[HHKB Fn] (ios testing)
     * ,-----------------------------------------------------------.
     * |Esc| F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|Ins|Del|
     * |-----------------------------------------------------------|
     * |Caps |Eject|WHOM|prev|play|next|   |   |Psc|Slk|Pus|Up |   |Backs|
     * |-----------------------------------------------------------|
    ...
    KEYMAP(GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, INS, DEL, \
           CAPS,EJCT,  WHOM, MPRV ,  MPLY,  MNXT,  NO,  NO,  PSCR,SLCK,PAUS, UP,  NO,  BSPC, \
